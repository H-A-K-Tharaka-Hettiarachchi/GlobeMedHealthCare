...
public class ReceptionLogin extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ReceptionLogin.class.getName());

    private GlobeMedHealthcare previousWindow;

    public ReceptionLogin(GlobeMedHealthcare previousWindow) {
