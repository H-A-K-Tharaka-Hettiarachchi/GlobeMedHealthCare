...
public class PharmacistLogin extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PharmacistLogin.class.getName());
    private GlobeMedHealthcare previousWindow;

    public PharmacistLogin(GlobeMedHealthcare previousWindow) {
